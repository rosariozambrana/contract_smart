...
class UrlConfigProvider with ChangeNotifier {
  ...
  /// Factory constructor que espera la inicialización completa
  static Future<UrlConfigProvider> create() async {
    final instance = UrlConfigProvider._internal();
    await instance._loadPreference();
    return instance;
  }
